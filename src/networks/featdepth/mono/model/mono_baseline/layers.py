...
def upshuffle(in_planes, upscale_factor):
    return nn.Sequential(
        ...
        nn.Conv2d(
            in_planes, in_planes * upscale_factor ** 2, kernel_size=3, stride=1, padding=0
        ),
...
class Conv1x1(nn.Module):
    def __init__(self, in_channels, out_channels, bias=False):
        ...
        self.conv = nn.Conv2d(
            int(in_channels), int(out_channels), kernel_size=1, stride=1, bias=bias
        )
