...
parser.add_argument(
    '--encoder',
    type=str,
    help='type of encoder, densenet121_bts or densenet161_bts',
...
map1, map2 = cv2.initUndistortRectifyMap(
    camera_matrix, dist_coeffs, R, new_camera_matrix, (640, 480), cv2.CV_32FC1
)
...
class Window(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        if self.glWidget.rgb.any() and self.glWidget.depth.any():
            ...
            coloredDepth = (plasma(self.glWidget.depth[:, :, 0])[:, :, :3] * 255).astype(
                'uint8'
            )
