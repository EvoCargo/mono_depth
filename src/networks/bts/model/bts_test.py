...
def test(params):
    ...
    for s in tqdm(range(num_test_samples)):
        if args.dataset == 'kitti':
            ...
            filename_image_png = (
                save_name + '/rgb/' + scene_name + '_' + lines[s].split()[0].split('/')[1]
            )
        ...
        if args.save_lpg:
            ...
            if args.dataset == 'nyu':
                plt.imsave(
                    filename_gt_png, np.log10(gt[10 : -1 - 9, 10 : -1 - 9]), cmap='Greys'
                )
