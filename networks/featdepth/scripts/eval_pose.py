...
try:
    ...
    from mono.datasets.utils import (
        compute_ate,
        dump_xyz,
        readlines,
...
def evaluate(data_path, model_path, sequence_id, height, width):
    filenames = readlines(
        "../mono/datasets/splits/odom/test_files_{:02d}.txt".format(sequence_id)
    )
...
if __name__ == "__main__":
    data_path = (
        '/media/user/harddisk/data/kitti/Odometry/dataset'  # path to kitti odometry
    )
