...
def main():
    ...
    model_filename = os.path.join(
        'results', 'imagenet.arch=mobilenet.lr=0.1.bs=256', 'model_best.pth.tar'
    )
    if os.path.isfile(model_filename):
        ...
        print(
            "=> loaded Imagenet pretrained model '{}' (epoch {}). best_prec1={}".format(
                model_filename, epoch, best_prec1
            )
        )
